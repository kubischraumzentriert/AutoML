...
Eine erste Arbeitshypothese nach nur 2 Datensaetzen (Groesse/Balance
erklaeren das Muster) **hielt nach dem vollstaendigen Rollout NICHT**:
`blood-transfusion` ist klein UND unausgeglichen und gewinnt trotzdem
deutlich, waehrend `ilpd` (ebenfalls klein/unausgeglichen) verliert.
**Ehrlicher Befund fuer die Paper-Story**: mehr Prozess-Komplexitaet ist
NICHT automatisch besser - Level 2 bringt bei diesem Tuning-Budget (10
Evals/Arm) keinen systematischen Mehrwert gegenueber Level 1/den fairen
...
Level-3-Untersuchung - beides nicht dringend, auf explizite
Nutzeranweisung.
