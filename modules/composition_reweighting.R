...
#
# LUECKE, die dieses Modul schliesst: eine CV-/Holdout-Metrik kann vom
# echten Leaderboard/Test deutlich abweichen, OHNE dass ein Modell-Bug oder
# Leak vorliegt - naemlich wenn Train/CV und Test in der Verteilung EINER
# Segmentspalte (Kategorie, Verfuegbarkeits-/Missingness-Flag, Zeit-seit-
# Ereignis-Bin, Fensterlaenge, ...) unterschiedlich zusammengesetzt sind.
# Dieses Modul beantwortet "ist die Luecke (ganz oder teilweise) ein
# KOMPOSITIONSEFFEKT" - rein LABEL-FREI, denn die Segmentzugehoerigkeit muss
# nur aus TEST-FEATURES ableitbar sein, nie aus Test-Labels.
#
# Ergaenzt `generalization_gap.R` (dort: STATISTISCHER Test, ob eine Luecke
# ungewoehnlich gross ist, gegen einen Referenzbereich aus Baselines) um
# eine andere Frage: nicht "ist die Luecke auffaellig gross", sondern "WARUM
# ist sie da - Komposition oder ein echtes Problem" - und das ohne
# Test-Labels.
#
...
# (Muster wie `generalization_gap_report()`/`hard_split_stress_test()`).
#
# BESTAETIGT AN 5 PROJEKTEN (2026-09-09, ADR-003 erfuellt, n=2-Minimum klar
# ueberschritten - siehe `docs/reference/SCRIPT_INDEX.md`):
...
#'   Metrik, z.B. AUC/RMSE je Fensterlaenge/Kategorie). Mehrere Messungen je
#'   Segment (z.B. CV-Folds) VORHER aggregieren (Mittelwert).
