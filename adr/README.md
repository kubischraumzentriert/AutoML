...
NEURAL_DEPLOY/EXPERIMENTS_DB dokumentiert waeren. Bewusst schlank gehalten
(kein Graph, keine Tooling-Abhaengigkeit) - passend zur Groesse dieses Repos.
...
`kubischraumzentriert/AutoML_Regression` (nicht als gemeinsame Referenz) -
siehe Begruendung in ADR 001 (keine Rueckverweise zwischen eigenstaendigen
Repos). Bei einer Aenderung an einer dieser Entscheidungen: die passende ADR
in BEIDEN Repos pruefen, nicht nur hier.
