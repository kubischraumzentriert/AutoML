...
**nachtraeglich** per `merge_project_experiments.R` befuellt:

- Findet Projekt-DBs automatisch unter den bekannten Wurzeln (`R_Workspace`,
  `ML_Learning`) - keine hardcodierte Liste, die veraltet.
...
- Ist als **letzter dokumentierter Workflow-Schritt** festgehalten
  (`WorkflowDescription.md` Phase 12), nicht als Code-Abhaengigkeit im
  Projekt selbst.
