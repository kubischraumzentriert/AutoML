...
weil sie genau das Kriterium aus `adr/README.md` erfuellt: echte Alternative,
und ein kuenftiger Agent koennte plausibel versucht sein, "der
Vollstaendigkeit halber" auch die Zeilentabellen mitzumergen)
...
und `prediction_prob` (eine Zeile je Beobachtung/Vorhersage, genutzt fuer
die Fehleranalyse in Phase 11).
...
1. **Zeilenebene ist projektspezifisch und projektuebergreifend nicht
   ...
   keinen auswertbaren Sinn. Nur INNERHALB eines Projekts (Phase-11-
   Fehleranalyse) ist diese Ebene relevant.
...
Fehleranalyse. Die zentrale DB eignet sich fuer aggregierte
Cross-Projekt-Fragen (Laufzeiten, Algorithmus-/Metrik-Muster,
Tuning-Erfolgsquote), NICHT fuer zeilengenaue Cross-Projekt-Analysen -
