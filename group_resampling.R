...
#
# BACKPORTIERT (2026-08-17) aus MLR3_Regression (dort seit laenger bestehend,
# `SubjektDatensatz`/Parkinson-Telemonitoring, `AStepAheadOfdrought`/
# Klima-Panel). `set_group_role()`/`diagnose_group_cv()` sind generisch
# (Measure-basiert) und wurden zuerst am 2026-08-15 an
# `openml-eeg-eye-state-timeseries` (Zeit-Block-Nachbarschaft, Random-CV
# BAcc 0.930 vs. Block-CV 0.717) und am 2026-08-17 unabhaengig ein zweites
