...
# high/low next-month construction-turnover target (Baden-Wuerttemberg/
# Stuttgart). Same standalone approach and conventions as the other pilots'
# compare_pilot.R (seed 42, classif.bacc/classif.mcc, ranger).
...
cat(sprintf("=== Baseline vs. Wetter-Vergleich (Baden-Wuerttemberg/Stuttgart, Baugewerbe, Einzelseed %d) ===\n", seed))
print(results)
