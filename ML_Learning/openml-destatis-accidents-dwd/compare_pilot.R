...
# high/low next-month road-accident-volume target (NRW/Koeln). Same
# standalone approach and conventions as the campsite pilot's compare_pilot.R
# (seed 42, classif.bacc/classif.mcc, ranger) - see that script's header for
# why this does not source the repo-root 000_config.R pipeline.
...
cat(sprintf("=== Baseline vs. Wetter-Vergleich (NRW/Koeln, Unfaelle, Einzelseed %d) ===\n", seed))
print(results)
