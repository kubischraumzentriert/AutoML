...
| `db_logging.R` | Zentrale `experiments.db`-Logging-Helfer (EAV-Schema plus JSON-Manifeste), von praktisch allen nummerierten Skripten genutzt ([Details](docs/reference/SCRIPT_INDEX.md#db_loggingr)) |
